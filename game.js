...
function nextSequence() {
  ...
  //4. Create a new variable called randomChosenColour and use
  // the randomNumber from step 2 to select a random colour from
  // the buttonColours array.
  var randomChosenColour = buttonColours[randomNumber];

  //6. Add the new randomChosenColour generated in step 4 to the end of the gamePattern.
  gamePattern.push(randomChosenColour);
   //7 Use jQuery to select the button with the same id as the randomChosenColour.
   //8. Use Google/Stackoverflow to figure out how you can use jQuery to animate 
...
//9. Use Google/Stackoverflow to figure out how you can use Javascript to 
